...
public class Luban {
    ...
    public Observable<List<File>> multiAction(final List<File> temp) {
            ...
            public void subscribe(ObservableEmitter<List<File>> e) throws Exception {
                ...
                if (gear == FIRST_GEAR){
                    for (File tempFile : temp) {
                        File file = firstCompress(tempFile);
                        if (file != null) {
                            files.add(file);
                        }
                    ...
                    for (File tempFile : temp) {
                        File file = thirdCompress(tempFile);
                        if (file != null) {
                            files.add(file);
                        }
                    }
